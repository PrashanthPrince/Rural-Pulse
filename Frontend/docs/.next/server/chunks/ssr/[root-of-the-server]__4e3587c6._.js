...
"[project]/components/shared/ProductForm.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/shared/ProductForm.js'\n\nExpected '</', got 'jsx text (\n                      )'");
...
function formatProductData(data) {
    ...
    return products.map((p)=>{
        const images = (p.image || []).map((img)=>`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STRAPI_URL"]}${img.formats?.thumbnail?.url}`);
        return {
            ...p,
...
"[project]/components/editProduct/EditProduct.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function EditProduct({ product: product1, onClose }) {
    ...
    const [saving, setSaving1] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleSubmit = async ({ formData, imageFiles, existingImages, selectedSlots = [], action })=>{
        setSaving1(true);
        try {
            ...
            const nonSelectedImages = existingImages.filter((img, index)=>!selectedSlots.includes(index));
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProductAPI"])(product1.documentId, formDataToSend);
            if (!data.success) throw new Error("Update failed");
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$toast$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Product saved successfully!", "success");
            setTimeout(()=>router1.push("/products"), 600);
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$toast$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(err.message || "Failed to update product", "error");
        } finally{
            setSaving1(false);
        }
    };
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$Sidebar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                onLogout: ()=>{
                    ...
                    router1.push("/products");
                },
                onCollapseChange: setSidebarCollapsed
            }, void 0, false, {
                fileName: "[project]/components/editProduct/EditProduct.js",
                lineNumber: 83,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$ProductForm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                initialData: {
                                    ...
                                    about_item: product1.about_item ?? "",
                                    product_details: product1.product_details ?? "",
                                    safety_information: product1.safety_information ?? "",
                                    usage_directions: product1.usage_directions ?? "",
...
const handleSubmit = async ({ formData, imageFiles, existingImages, selectedSlots = [], action })=>{
    ...
    try {
        ...
        formDataToSend.append("status", action);
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProductAPI"])(product.documentId, formDataToSend);
        if (!data.success) throw new Error("Update failed");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$toast$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Product saved successfully!", "success");
...
"[project]/app/products/edit/[id]/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$editProduct$2f$EditProduct$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/editProduct/EditProduct.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/productApi.js [app-ssr] (ecmascript)");
"use client";
;
;
...
function EditProductPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadProduct() {
            ...
            try {
                ...
                // Handle new format from backend (draftProducts + publishedProducts)
                let allProducts = [];
                // Check if products object contains draftProducts and publishedProducts
                if (data.products && data.products.draftProducts !== undefined && data.products.publishedProducts !== undefined) {
                    const formattedDraft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.products.draftProducts || []);
                    const formattedPublished = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.products.publishedProducts || []);
                    // Merge: draft products first, then published products that aren't in draft
                    const draftIds = new Set(formattedDraft.map((p)=>p.documentId));
                    const uniquePublished = formattedPublished.filter((p)=>!draftIds.has(p.documentId));
                    allProducts = [
                        ...formattedDraft,
                        ...uniquePublished
                    ];
                } else if (data.draftProducts !== undefined && data.publishedProducts !== undefined) {
                    const formattedDraft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.draftProducts || []);
                    const formattedPublished = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.publishedProducts || []);
                    const draftIds = new Set(formattedDraft.map((p)=>p.documentId));
                    const uniquePublished = formattedPublished.filter((p)=>!draftIds.has(p.documentId));
                    allProducts = [
                        ...formattedDraft,
                    ...
                    allProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.products);
                } else if (data.products) {
                    allProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatProductData"])(data.products);
                }
                const found = allProducts.find((p)=>p.documentId === id);
                if (!found) {
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/app/products/edit/[id]/page.js",
        lineNumber: 62,
        columnNumber: 23
    }, this);
    if (!product) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$editProduct$2f$EditProduct$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        product: product,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e3587c6._.js.map