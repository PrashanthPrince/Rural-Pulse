...
async function uploadToStrapiMediaLibrary(files) {
    ...
    const token = localStorage.getItem("token");
    console.log("uploadToStrapiMediaLibrary: Uploading", files.length, "file(s) to", `${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STRAPI_URL"]}/api/upload`);
...
async function updateProductAPI(documentId, formDataOrPayload) {
    ...
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/products/update/${documentId}`, options);
    const data = await res.json();
    if (!res.ok) {
...
async function fetchVariantByIdAPI(variantId) {
    try {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/variants/${variantId}?status=draft`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function createVariantAPI(variantData) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/variants?status=draft`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function updateVariantAPI(documentId, variantData) {
    try {
        ...
        const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/variants/${documentId}?status=draft`;
...
async function publishVariantAPI(documentId) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/variants/${documentId}?status=published`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function fetchDraftVariantsAPI(productDocumentId) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/products/${productDocumentId}/draft-variants?status=draft`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function unsetOtherDefaultsAPI(productId, defaultVariantId) {
    try {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/products/${productId}/unset-other-defaults`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function uploadVariantImages(files) {
    const formData = new FormData();
    files.forEach((file)=>formData.append("files", file));
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/upload/variants/images`, {
        method: "POST",
        body: formData,
        credentials: "include"
    });
...
async function uploadVariantVideos(files) {
    const formData = new FormData();
    files.forEach((file)=>formData.append("files", file));
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/upload/variants/videos`, {
        method: "POST",
        body: formData,
        credentials: "include"
    });
...
async function fetchCategoriesAPI() {
    try {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/categories`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function fetchSubcategoriesAPI() {
    try {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/subcategories`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function fetchFAQsAPI(options = {}) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/faqs${query.toString() ? "?" + query : ""}`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function fetchFAQByIdAPI(faqId) {
    try {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/faqs/${faqId}`, {
            method: "GET",
            credentials: "include"
        });
        const data = await res.json();
...
async function createFAQAPI(faqData, status = "published") {
    try {
        const payload = {
            Question: faqData.Question || faqData.question,
            Answer: faqData.Answer || faqData.answer
        };
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/faqs?status=${status}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function updateFAQAPI(faqId, updateData, status = "published") {
    try {
        const payload = {
            Question: updateData.Question || updateData.question,
            Answer: updateData.Answer || updateData.answer
        };
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/faqs/${faqId}?status=${status}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function linkProductsToFAQAPI(faqId, productIds) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/faqs/${faqId}/products`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
async function fetchFAQsByProductAPI(productId) {
    try {
        const endpoint = `${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/products/${productId}/faqs`;
...
async function linkFAQsToProductAPI(productDocumentId, faqIds) {
    try {
        ...
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$apiConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"]}/products/${productDocumentId}/link-faqs`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        if (!res.ok) {
            ...
            console.error("   Response status:", res.status);
            console.error("   Response data:", data);
            throw new Error(data?.error?.message || data?.error || data?.message || "Failed to link FAQs to product");
        }
        ...
        const loadCategoriesAndSubcategories = async ()=>{
            try {
                const [categoriesData, subcategoriesData] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCategoriesAPI"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$productApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchSubcategoriesAPI"])()
                ]);
                                            ...
                                            children: [
                                                ...
                                                showFilterDropdown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: categories.length > 0 ? categories.filter((cat)=>cat.categoryName?.toLowerCase().includes(filterSearch.toLowerCase())).map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: (()=>{
                                                                        ...
                                                                        return availableSubcategories.length > 0 ? availableSubcategories.filter((subcat)=>subcat.subcategoryname?.toLowerCase().includes(filterSearch.toLowerCase())).map((subcat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                                className: "flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                                        type: "checkbox",
                                                        ...
                                                        (selectedCategories.length > 0 || selectedSubcategories.length > 0 || filterStatus !== "all") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: (()=>{
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                children: [
                                                                    categoryNames && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    subcategoryNames && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "font-semibold",
