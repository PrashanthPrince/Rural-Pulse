...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    Store_keeping_Unit: Schema.Attribute.String;
    style: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant_name: Schema.Attribute.String & Schema.Attribute.Required;
    varientImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    variety_type: Schema.Attribute.String;
    weight: Schema.Attribute.Decimal;
    weight_unit: Schema.Attribute.Enumeration<['kg', 'g', 'L', 'ml']>;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about_item: Schema.Attribute.Text;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    safety_information: Schema.Attribute.Text;
    sub_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::sub-category.sub-category'
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usage_directions: Schema.Attribute.Text;
